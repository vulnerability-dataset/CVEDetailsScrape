CREATE TABLE IF NOT EXISTS `CLASSES_6_tomcat` (
	ID_Class BIGINT,
	P_ID CHAR(255), 
	Visibility CHAR(10), 
...
DROP TABLE IF EXISTS `FUNCTIONS_6_tomcat`;
CREATE TABLE IF NOT EXISTS `FUNCTIONS_6_tomcat` (
	ID_Function BIGINT, 
	P_ID 		CHAR(255), 
	Visibility 	CHAR(10), 
...
DROP TABLE IF EXISTS `FILES_6_tomcat`;
CREATE TABLE IF NOT EXISTS `FILES_6_tomcat` (
	ID_File BIGINT, 
	P_ID CHAR(255), 
