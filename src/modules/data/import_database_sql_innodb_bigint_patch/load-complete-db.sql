...
SELECT NOW() as '  ', 'Create tables TIMELINE from Glibc' as '  ' FROM DUAL;

source ./scripts/glibc/EXTRA-TIME-CLASS1000.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/glibc/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/glibc/EXTRA-TIME-FILES1000.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/glibc/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/glibc/EXTRA-TIME-FUNCTIONS1000.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/glibc/EXTRA-TIME-FUNCTIONS1001.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Httpd' as '  ' FROM DUAL;

source ./scripts/httpd/EXTRA-TIME-CLASS1000.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/httpd/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/httpd/EXTRA-TIME-FILES1000.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/httpd/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/httpd/EXTRA-TIME-FUNCTIONS1000.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/httpd/EXTRA-TIME-FUNCTIONS1001.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Xen' as '  ' FROM DUAL;

source ./scripts/xen/EXTRA-TIME-CLASS1000.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/xen/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/xen/EXTRA-TIME-FILES1000.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/xen/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/xen/EXTRA-TIME-FUNCTIONS1000.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/xen/EXTRA-TIME-FUNCTIONS1001.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Kernel' as '  ' FROM DUAL;

source ./scripts/kernel/EXTRA-TIME-CLASS1000.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/kernel/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/kernel/EXTRA-TIME-FILES1000.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/kernel/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/kernel/EXTRA-TIME-FUNCTIONS1000.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/kernel/EXTRA-TIME-FUNCTIONS1001.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Mozilla' as '  ' FROM DUAL;

source ./scripts/mozilla/EXTRA-TIME-CLASS1000.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/mozilla/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/mozilla/EXTRA-TIME-FILES1000.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/mozilla/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/mozilla/EXTRA-TIME-FUNCTIONS1000.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/mozilla/EXTRA-TIME-FUNCTIONS1001.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Tomcat' as '  ' FROM DUAL;

source ./scripts/tomcat/EXTRA-TIME-CLASS1000.sql
source ./scripts/tomcat/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/tomcat/EXTRA-TIME-CLASS1002.sql
source ./scripts/tomcat/EXTRA-TIME-CLASS1003.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/tomcat/EXTRA-TIME-FILES1000.sql
source ./scripts/tomcat/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/tomcat/EXTRA-TIME-FILES1002.sql
source ./scripts/tomcat/EXTRA-TIME-FILES1003.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/tomcat/EXTRA-TIME-FUNCTIONS1000.sql
source ./scripts/tomcat/EXTRA-TIME-FUNCTIONS1001.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/tomcat/EXTRA-TIME-FUNCTIONS1002.sql
source ./scripts/tomcat/EXTRA-TIME-FUNCTIONS1003.sql

SELECT NOW() as '  ', 'Create tables TIMELINE from Derby' as '  ' FROM DUAL;

source ./scripts/derby/EXTRA-TIME-CLASS1000.sql
source ./scripts/derby/EXTRA-TIME-CLASS1001.sql
SELECT NOW() as '  ', '16%...' as '  ' FROM DUAL;
source ./scripts/derby/EXTRA-TIME-CLASS1002.sql
source ./scripts/derby/EXTRA-TIME-CLASS1003.sql
SELECT NOW() as '  ', '33%...' as '  ' FROM DUAL;
source ./scripts/derby/EXTRA-TIME-FILES1000.sql
source ./scripts/derby/EXTRA-TIME-FILES1001.sql
SELECT NOW() as '  ', '50%...' as '  ' FROM DUAL;
source ./scripts/derby/EXTRA-TIME-FILES1002.sql
source ./scripts/derby/EXTRA-TIME-FILES1003.sql
SELECT NOW() as '  ', '66%...' as '  ' FROM DUAL;
source ./scripts/derby/EXTRA-TIME-FUNCTIONS1000.sql
source ./scripts/derby/EXTRA-TIME-FUNCTIONS1001.sql
SELECT NOW() as '  ', '82%...' as '  ' FROM DUAL;
source ./scripts/derby/EXTRA-TIME-FUNCTIONS1002.sql
source ./scripts/derby/EXTRA-TIME-FUNCTIONS1003.sql

source ./scripts/83-update_idfunctions_EXTRATIMES.sql
