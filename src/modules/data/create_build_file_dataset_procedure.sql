...
CREATE PROCEDURE BUILD_FILE_DATASET(IN iMETRICS_TABLE VARCHAR(200), IN iOUTPUT_CSV_PATH VARCHAR(3000),
...
BEGIN
	...
	-- iFILTER_INELIGIBLE_SAMPLES is not necessary for files.
	...
	WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'FILES_5';

	SET @QUERY = CONCAT(
		'(SELECT 	"Description", "COMMIT_HASH", "COMMIT_DATE", "COMMIT_YEAR", "VULNERABILITY_CVE", "VULNERABILITY_YEAR",
					"VULNERABILITY_CWE", "VULNERABILITY_CATEGORY", ', @METRICS_COLUMNS, ', "COMMIT_HAS_ALERTS", "TOTAL_ALERTS", ', @ALERT_COLUMNS,
		')
