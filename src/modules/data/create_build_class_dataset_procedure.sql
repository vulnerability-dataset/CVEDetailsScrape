...
CREATE PROCEDURE BUILD_CLASS_DATASET(IN iMETRICS_TABLE VARCHAR(200), IN iOUTPUT_CSV_PATH VARCHAR(3000),
...
BEGIN
	...
	WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'CLASSES_5';
